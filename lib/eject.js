...
const mergeEjectedFiles = require('./utils/eject/merge-ejected-files');
...
async function eject() {
  try {
    ...
    // Merge the ejected files in the temp folder with the source files.
    mergeEjectedFiles(ejectedProjectPath);
