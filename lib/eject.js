...
======================================================================
 ATTENTION!
  You are running an outdated version of the \`skyux eject\` command!
  Run \`npm install --global @skyux-sdk/cli@next\` to get the latest
  features, then rerun \`skyux eject\`.
======================================================================
`);
