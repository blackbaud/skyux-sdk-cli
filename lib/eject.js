...
const moveFiles = require('./utils/eject/move-files');
...
async function eject() {
  try {
    ...
    // Move files.
    moveFiles.moveSourceFilesToTemp(ejectedProjectPath, SOURCE_CODE_BACKUP_TEMP_DIR);
    moveFiles.moveEjectedFilesToCwd(ejectedProjectPath);
