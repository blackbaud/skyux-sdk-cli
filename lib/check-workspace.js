...
function validateArchitectBuilder(architect, project, projectName) {
    ...
    switch (project.projectType) {
      case 'application':
        for (const architect of ['build', 'serve', 'test']) {
          validateArchitectBuilder(architect, project, projectName);
        }
        ...
        break;
      case 'library':
        validateArchitectBuilder('test', project, projectName);
        break;
    }
  }
}
