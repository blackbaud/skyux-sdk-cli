...
function createSkyPagesModule(ejectedProjectPath, routes) {
  ...
  fs.writeFileSync(path.join(ejectedProjectPath, 'src/app/sky-pages.module.ts'),
...
function createNotFoundComponent(ejectedProjectPath) {
...
async function eject() {
  try {
    ...
    createNotFoundComponent(ejectedProjectPath);
