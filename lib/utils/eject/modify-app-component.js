...
function buildSpecContents(useEsLint) {
...
@Component({
  ${useEsLint ? '// eslint-disable-next-line @angular-eslint/component-selector' : '// tslint:disable-next-line: component-selector'}
 ...
 */
 function modifyAppComponent(ejectedProjectPath, useEsLint = false) {
  fs.writeFileSync(
