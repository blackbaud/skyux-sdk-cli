...
async function eject(argv = {}) {
  try {
    ...
    if (
      ...
      throw new Error('The eject command is only available to SKY UX 4 projects. Aborting.');
    }
    ...
    const isInternal = (argv.internal || gitOriginUrl.startsWith('https://blackbaud.visualstudio.com/'));
    ...
    // Add the SKY UX Angular builders and update SKY UX dependencies.
