...
const npmCi = require('./utils/npm-ci');
...
async function eject() {
  try {
    ...
    const ejectedProjectPath = path.join(CWD, '.skyuxejecttemp');
    ...
    // Run `npm ci` after all files have been merged to regen the node_modules.
